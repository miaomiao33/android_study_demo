...
import com.example.android_study_demo_project.bean.Data;
...
public class CleanArchitectureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Gateway层
        UserGateway userGateway = new UserGatewayImpl();//数据库操作
        //Interactor层
        GetUserUseCase userInteractor = new UserInteractor(userGateway);//业务操作，获取user，添加user

        UserListViewAdapter adapter = new UserListViewAdapter(userInteractor,CleanArchitectureActivity.this);
        // presentation层
        UserPresenter userPresenter = new UserPresenter(adapter,userInteractor);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()); // 定义时间格式
                User user = new User(dateFormat.format(calendar.getTime()), "John Doe", "john.doe@example.com");
