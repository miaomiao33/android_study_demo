...
echo "===== Start compile LibreDWG arm64-v8a ====="
# NDK目录
...
# --with-python_prefix=DIR：Python 安装根目录
PYTHON_PREFIX=/e/python3.6.4
# --with-python_exec_prefix=DIR：Python 二进制库目录
PYTHON_EXEC_PREFIX=/e/python3.6.4
...
./configure --prefix="$PREFIX" \
 ...
 --with-python_prefix=$PYTHON_PREFIX \
 --with-python_exec_prefix=$PYTHON_EXEC_PREFIX
